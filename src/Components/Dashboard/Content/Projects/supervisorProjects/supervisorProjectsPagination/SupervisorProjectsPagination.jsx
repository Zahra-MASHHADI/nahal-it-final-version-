...
import { getCategories, getProjects, getSupervisorProjects, getUsers } from '../../../../../../features/dashboard/action';
...
function SupervisorProjectPagination() {
    ...
    const isLoading = useSelector(state => state.dashboard.supervisorprojectsLoading);
